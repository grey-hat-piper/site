...
const FaqItem = ({title, description}) => {
  ...
  return (
    <div className='w-full border-b'>
        ...
        {/* description */}
        <div className={`${isOpen ? "max-h-0[200px] opacity-100 p-[4px] transition-all duration-500 ease-in-out" : "max-h-0 opacity-0 p-0 transition-all duration-300 ease-in-out overflow-hidden"}`}>
